...
if (isset($_POST['update'])){
    ...
    if($conn->query($sql)){
        ...
        echo "<script>myAlert('Record Update Successfully','success','fieldsShow');</script>";
        } else{
        echo "<script>myAlert(Record Update Not Successfully','error','fieldsShow_edit');</script>";
        }
}
?>
</head>
                ...
                <div class="container">
                    <form onsubmit="return nullcheck();" action="" method="POST">
                        ...
                        <div>
                            ...
                            <input type="text" id="field_name" name="field_name" value="<?=$id; ?>"
